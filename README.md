...
Importante; asegúrate de colocar adecuadamente la ruta al archivo "best.pt" en el código de 'demostrador'. Puedes o bien ubicar el archivo 'best.pt' en la misma carpeta que el archivo 'demostrador' o bien modificar la línea 8 del archivo 'demostrador' para modificar la ruta al archivo 'best.pt' dependiendo de donde se encuentre este en tu dispositivo.
